...
class Authentication {
  ...
  static Future<UserSchema.User?> signInWithGoogle(
    ...
    if (kIsWeb) {
      ...
      if (googleSignInAccount != null) {
        ...
        try {
          ...
          UserSchema.User? LoggedUser =
              await ApiService().createUser(displayName, email);

          UserSchema.User? _DataUser =
              await ApiService().getUsers(LoggedUser!.id.toString());
          DataUser = _DataUser;
          user = userCredential.user;
